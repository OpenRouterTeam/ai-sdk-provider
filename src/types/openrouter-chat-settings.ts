...
export type OpenRouterChatSettings = {
  ...
  provider?: {
    ...
    max_price?: {
      /**
       * The maximum price for the prompt.
       */
      prompt?: number | string;
      /**
       * The maximum price for the completion.
       */
      completion?: number | string;
      /**
       * The maximum price for an image.
       */
      image?: number | string;
      /**
       * The maximum price for audio.
       */
      audio?: number | string;
      /**
       * The maximum price for the request.
       */
